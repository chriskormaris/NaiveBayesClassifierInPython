...
![Laplace Smoothing token](http://latex.codecogs.com/gif.latex?\frac{tokenFrequencyInSpamClass[i]%20&plus;%201}%20{numberOfSpamDocuments%20&plus;%20numberOfFeatures}%20%3D%20\frac{spamDocumentFrequencyOfToken[i]%20&plus;%201}%20{numberOfWordsInSpamClass%20&plus;%20|V|})
...
![Laplace Smoothing vector](http://latex.codecogs.com/gif.latex?probOfFeatureVectorBelongingToSpam%20%3D%20\frac{P(C%3D1)}{P(featureVector)}%20\cdot%20\prod_i%20\frac{spamDocumentFrequencyOfToken[i]%20&plus;%201}%20{numberOfWordsInSpamClass%20&plus;%20|V|})
